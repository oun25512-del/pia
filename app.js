...
/* ==============================
   API Key — บันทึกใน sessionStorage
   ============================== */
function getApiKey() {
...
/* ==============================
   AI — direct browser call
   ใช้ header anthropic-dangerous-direct-browser-access
   เพื่อข้าม CORS โดยไม่ต้องรัน server
   ============================== */
  ...
  if (!apiKey || !apiKey.startsWith("sk-ant-")) {
    ...
    output.innerHTML = `
      ...
      <p style="margin-top:6px;font-size:13px;color:#888">
        รับ Key ได้ที่ <a href="https://console.anthropic.com/" target="_blank">console.anthropic.com</a>
        แล้วกรอกในช่องด้านบน
      </p>`;
