...
/* ==============================
   AI — ใช้ Anthropic API โดยตรง
   ไม่ต้องการ API Key จากผู้ใช้
...
async function askAI() {
  ...
  if (rows.length === 0) {
    ...
    output.innerHTML = `<p style="color:#c0392b">กรุณาเพิ่มอุปกรณ์ก่อนขอคำแนะนำ</p>`;
    return;
  }
  ...
  try {
    const response = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      headers: {
        ...
        // ไม่ต้องใส่ x-api-key — Claude จัดการให้อัตโนมัติ
      },
      body: JSON.stringify({
